...
#include "../ext/customimgui/Font.h"
...
void RenderFrame(IDXGISwapChain* g_pSwapChain)
{
    static auto lastTime = std::chrono::high_resolution_clock::now();
    const double frameTime = 1.0 / cfg::maxFPS;
    ...
    if (!cfg::vsync)
    {
        ...
        {
            double sleepTime = (frameTime - elapsed.count()) * 1000.0;
            if (sleepTime > 0.0)
