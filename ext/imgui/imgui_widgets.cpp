...
#include "../customimgui/imgui_setting.h"
#include "../customimgui/custom.hpp"
...
bool ImGui::Tabs(bool selected, const char* icon, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.shadow = ImLerp(it_anim->second.shadow, selected ? (ImVec4)ImColor(0, 106, 255, 255) : (ImVec4)ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.text = ImLerp(it_anim->second.text, selected ? (ImVec4)ImColor(0, 106, 255, 255) : (hovered ? (ImVec4)ImColor(0, 0, 0, 255) : settings::tabs::text), g.IO.DeltaTime * 6.f);
...
bool ImGui::SubTab(bool selected, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.text = ImLerp(it_anim->second.text, selected ? (ImVec4)ImColor(0, 106, 255, 255) : settings::tabs::text, g.IO.DeltaTime * 6.f);
